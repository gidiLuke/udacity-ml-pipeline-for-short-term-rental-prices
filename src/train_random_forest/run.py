...
def go(args):
    ...
    logger.info("Using artifact: %s", args.trainval_artifact)
    ...
    mlflow.sklearn.save_model(sk_model=sk_pipe, path=model_path)
    ######################################
    ...
    artifact.add_dir(local_path=model_path)
    run.log_artifact(artifact)
    logger.info(msg="Artifact logged.")
    ######################################
